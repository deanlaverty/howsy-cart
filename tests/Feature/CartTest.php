...
final class CartTest extends TestCase
{
    ...
    {
        $cart = $this->cart->create($this->user);
    ...
    {
        $this->userService = Mockery::mock(UserServiceInterface::class, function (MockInterface $mock) {
            $mock->shouldReceive('hasAgreedToContract')
                ->once()
                ->andReturn(true);
        })->makePartial();

        $this->container->set(UserServiceInterface::class, $this->userService);
